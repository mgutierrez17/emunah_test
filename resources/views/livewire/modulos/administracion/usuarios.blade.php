<div class="p-4">
    <div class="flex justify-between items-center mb-4">
        <div class="flex w-full max-w-md">
            <input type="text" wire:model.debounce.300ms="search" placeholder="Buscar usuario..."
                class="w-full px-4 py-2 border rounded-l-md focus:outline-none focus:ring focus:border-blue-300">
            ...
            @foreach ($usuarios as $usuario)
                <tr class="border-t">
                    ...
                    <td class="p-2 flex space-x-2 justify-center">
                        ...
                        <button wire:click="eliminar({{ $usuario->id }})" class="text-red-600"
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
                ...
                <div class="flex justify-end space-x-2">
                    <button wire:click="$set('modal', false)"
                        class="bg-gray-400 px-4 py-2 rounded text-white">Cancelar</button>
